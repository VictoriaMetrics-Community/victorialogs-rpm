...
%changelog
* Tue June 4 2024 Denys Holius <rpm@victoriametrics.com>
- Updated to version v0.16.0-victorialogs
  See Full Changelog at https://github.com/VictoriaMetrics/VictoriaMetrics/releases/tag/v0.16.0-victorialogs
